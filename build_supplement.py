...
STRUCTURE = [
    ...
    ("section", "9_rq6_combined_bias_reduction_est.html", "bias-reduction-ip-weighted-vs-unadjusted-attritioned-estimates", "Weighted vs. Unadjusted"),
    ("section", "9_rq6_combined_bias_reduction_est.html", "bias-reduction-imputed-vs-unadjusted-attritioned-estimates", "Imputed vs. Unadjusted"),

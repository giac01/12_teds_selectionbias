...
[Click here for full-size plot](plots/5_1_missing_data_frequency.pdf){target="_blank"}
...
ggsave(file.path("plots", "5_1_missing_data_frequency.pdf"), height = 32, width = 12)

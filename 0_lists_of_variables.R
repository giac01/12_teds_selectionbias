...
rq7z_vars = c(
  ...
  # Cognitive composites
  "jcg1",         # General cognitive ability
  "jcg2",         # General cognitive ability
  # "jcnv1",        # Non-verbal ability
  # "jcnv2",        # Non-verbal ability
  # "jcvb1",        # Verbal ability
  # "jcvb2",        # Verbal ability
  ...
  "rcqucast1",         # "UCAS point score total estimate from known UK exam results (twin qnr at 18)"
  "rcqucast2",         # "UCAS point score total estimate from known UK exam results (twin qnr at 18)"
  
  ## Year 21 variables ----------------------------------------------------
  "u1chqualp1",        #"Twin probable highest level of qualification including current study (TEDS21 phase 1 twin qnr), 1-11 see value labels"
  "u1chqualp2",
  # Twin-reported SDQ
  # "u1csdqemot1", # Emotion
  # "u1csdqemot2", # Emotion
  ...
  ## Year 26 variables ----------------------------------------------------
  "zmhhqual1", # Demographics item: highest qualification ordinal level (TEDS26 twin MHQ), see value labels
  "zmhhqual2",
  # Twin-reported SDQ
  # "zmhsdqemot1", # Emotion
  # "zmhsdqemot2", # Emotion

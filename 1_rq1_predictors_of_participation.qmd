---
title: "RQ1: Y2 predictors of attrition at later time points"
format: 
  html:
...
ggplot(heatmap_data, aes(x = Variables_wrapped, y = outcome_labeled)) +
  geom_tile(aes(fill = Delta_AUC_fill, 
                color = ifelse(Variables_Dropped %in% c("astress", "atwmed1", "adrink", "anyngsib"), "azure2", "black")), 
            size = .5) +
